 <!-- open navbar -->
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div style="display: flex; flex-direction: row;">
         ...
         <a id="masuk" href="login.php" style="text-decoration: none; color: white; font-weight: bolder; background-color: #0099ff; transition: background-color 0.3s; border-radius: 5px; padding: 10px;" onmouseover="this.style.color='#0099ff'; this.style.backgroundColor='white';" onmouseout="this.style.color='white'; this.style.backgroundColor='#0099ff';">Masuk</a>

          <a href="" style="text-decoration: none; color: black; font-weight: bolder; margin-left: 10px; margin-right: 10px; padding: 10px;">/</a>

          <a id="masuk" href="register.php" style="text-decoration: none; color: white; font-weight: bolder; background-color: #0099ff; transition: background-color 0.3s; border-radius: 5px; padding: 10px;" onmouseover="this.style.color='#0099ff'; this.style.backgroundColor='white';" onmouseout="this.style.color='white'; this.style.backgroundColor='#0099ff';">Daftar</a>
  ...
  <!-- close navbar -->
    ...
    <!-- open wave -->
  <div style="margin-top: -75px; position: fixed; z-index: 9998; left: 0; right: 0;">
